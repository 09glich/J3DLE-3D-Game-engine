Hello and welcome to the J3DEngine git repo This is an in development engine written primaraly in the Java language that takes heavy inspiration from Unity engine. This engine was made as a project to learn how engine backends actualy work
